        ...
        <div className="space-y-12 text-rp-ivory font-sans font-normal tracking-[-0.02em] leading-[1.15]">
          ...
          <section>
            ...
            <div className="space-y-4 text-base md:text-lg">
              ...
              <p>The company is referred to as either "the Company", "We", "Us" or "Our" in this Agreement.</p>
              <p>
              ...
              <p>
                ...
                form the entire agreement between the parties regarding the use of the Service.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="space-y-4 text-base md:text-lg">
              <p>
                ...
                between the parties. These Terms and Conditions set out the rights and obligations of all users
          ...
          <section>
            ...
            <p className="text-base md:text-lg">
              The laws of the Company's incorporation place, excluding its conflicts of law rules, shall govern these
              Terms and Your use of the Service. Your use of the Application may also be subject to other local, state,
          ...
          <section>
            ...
            <div className="space-y-4 text-base md:text-lg">
              ...
              <p>
                Except as provided herein, the failure to exercise a right or to require the performance of an
                obligation under these Terms shall not affect a party's ability to exercise such right or require such
